...
Criar uma aplicação que fará o cadastro dos pedidos de uma hamburgueria, e você deve utilizando [Node](https://nodejs.org/en/) e [Express](https://expressjs.com/pt-br/).
